      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div className="space-y-6 md:space-y-8">
            <WalletInfo />
            <div className="p-6 bg-card-background text-card-foreground rounded-lg shadow-md border border-border">
              <h2 className="text-2xl font-bold mb-4">Recipient Settings</h2>
              <div>
